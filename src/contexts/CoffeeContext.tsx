...
} from '../reducers/CoffeInCart/actions'
import { coffessCartReducer } from '../reducers/CoffeInCart/reducers'
...
export function CoffeeContextProvider({
  ...
  const [coffeesInCart, dispatch] = useReducer(coffessCartReducer, [])
